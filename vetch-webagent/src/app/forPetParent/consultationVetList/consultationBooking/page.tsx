            ...
            <div className="min-h-screen bg-[#FBFFE4] dark:bg-[#2E4F4A] p-8">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-4 p-4 rounded-xl bg-white shadow">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-semibold mt-2 text-green-900">Specialty</p>
                                <div className="flex flex-wrap gap-2 mt-1">
                                    {["Dermatology", "Nutrition", "Cardiology", "Immunology"].map(
                                    (tag) => (
                                        <span key={tag} className="px-3 py-1 rounded-full bg-gray-100 border text-sm">
                                        {tag}
                                        </span>
                                    ))}
                                </div>
                ...
                {/* Right Column */}
                    <div className="space-y-6">
                        ...
                        {/* Location */}
                        <div className="p-4 bg-white rounded-xl shadow flex items-start gap-3">
                ...
                <div className="flex">
                    ...
                    <div className="w-2/3 pr-4 border-r">
                        <p className="font-semibold text-green-900 mb-3">Price</p>
                    ...
                    <div className="w-1/3 pl-4">
                        <p className="font-semibold text-green-900 mb-3">Pay Using</p>
