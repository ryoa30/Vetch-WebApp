                ...
                {articles.map((article) => (
                    ...
                    >
                        ...
                        <div className='flex flex-col items-start'>
                            <span className="text-base text-black dark:text-white font-medium">{article.categoryName}</span>
                            <h4 className="text-xl text-black dark:text-white font-semibold mt-1 leading-snug text-justify">{article.title}</h4>
                            <p className="text-sm font-normal mt-1 text-black dark:text-white">{formatDateArticle(article.date)}</p>
                        </div>
                    </button>
                ))}
            </div>
