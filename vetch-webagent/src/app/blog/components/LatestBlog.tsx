...
const LatestArticle: React.FC<Props> = ({ article }) => (
  <div className="md:basis-[55%] w-full">
    <div className="bg-white p-5 rounded-xl border-[6px] border-teal-400">
      ...
      <div className="rounded-lg overflow-hidden">
        ...
        <p className="text-base mt-4 text-black line-clamp-3 text-justify">
          {article.summary}
        </p>

        <Link
          href={`/blog/${article.slug}`}
          className="inline-block mt-4 bg-teal-700 text-white px-4 py-2 rounded hover:bg-teal-600"
        >
          Baca Selengkapnya
        </Link>
      </div>
